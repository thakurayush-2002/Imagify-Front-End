...

{
        user ? <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={()=>nevigate("/buy")} className='flex cursor-pointer items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
            ...
            <div className="relative group">
                ...
                <div className="absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12">
                    <ul className='list-none m-0 p-2 bg-white rounded-md border border-gray-300 text-sm'>
                        <li
                        onClick={logout}
                         className='cursor-pointer py-1 px-2 pr-10'>Logout</li>
                    </ul>
                </div>
            </div>
        </div>
      ...
      <p className='cursor-pointer'onClick={ ()=>nevigate ("/buy")}>Pricing</p>
