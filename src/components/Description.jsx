...
const Description = () => {
  return (
    <motion.div 
                     ...
                     viewport={{once:true}} >
           <div className=' flex items-center justify-center my-24 flex-col p-6 mb:px-28'>
          ...
          <div className=" flex flex-col gap-5 md:gap-14 md:flex-row items-center">
            ...
            <p className='text-gray-600'>
                Simply type in a text prompts , and our cutting-edge AI will generate high-qulity image in seconds. From product visuals to character designs and portraits, even concepts that don't yet exist can be visualized effortlessly . Powered by advanced AI technology , the creative possibilities are limitless!
            </p>
              </div>
          </div>
