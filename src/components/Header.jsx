    ...
    <motion.div
      ...
      className="flex flex-col items-center justify-center text-center my-20">
        <motion.div 
                ...
                <p >Bast text to image generator </p>
       ...
       <motion.h1 
                    ...
                    className=' text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto text-center mt-10'>Turn text to <samp className='text-blue-600'>image</samp>, in seconds. </motion.h1>
       ...
       <motion.button  
                          ...
                          onClick={onClickHandler}
                           className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'>Generate Images <img className='h-6' src={assets.star_group} alt="" />
       </motion.button>
